...
// Specific one-off dates the office is closed on top of the regular weekly
// schedule (holidays, staff events, etc.) — add/remove dates here as needed,
// in YYYY-MM-DD format. This is checked everywhere a booking can be made:
// Rose's tools, and the website's own booking endpoint.
const CLOSED_DATES = ['2026-09-21', '2026-09-24', '2026-09-27', '2026-10-04'];
...
// Single source of truth for "is the office closed on this date, and why."
// Returns null if open, or a caller-friendly reason string if closed.
